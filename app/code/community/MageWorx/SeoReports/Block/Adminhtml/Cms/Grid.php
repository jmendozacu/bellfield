...
class MageWorx_SeoReports_Block_Adminhtml_Cms_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    public function __construct()
    {
        ...
        if (!Mage::registry('error_types')){
            Mage::register('error_types', Mage::helper('mageworx_seoreports')->getErrorTypes());
        }
    }
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getResourceModel('mageworx_seoreports/cms_collection');
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'meta_title',
            array(
            'header' => Mage::helper('mageworx_seoreports')->__('Title'),
            'type'   => 'text',
            'index'  => 'meta_title',
            'align'  => 'left',
            )
        ...
        $this->addColumn(
            ...
            'type'     => 'options',
            'options'  => Mage::helper('mageworx_seoreports')->getErrorTypes(array('missing', 'duplicate')),
            'header'   => Mage::helper('mageworx_seoreports')->__('Content Heading'),
            'index'    => 'heading_error',
            'sortable' => false,
            'width'    => '100px',
            'align'    => 'center',
        ...
        $this->addColumn(
            ...
            'filter'   => 'mageworx_seoreports/adminhtml_grid_filter_error',
            'type'     => 'options',
            'options'  => Mage::helper('mageworx_seoreports')->getErrorTypes(array('long', 'duplicate')),
