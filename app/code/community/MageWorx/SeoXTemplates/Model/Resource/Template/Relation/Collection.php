 ...
 */
abstract class MageWorx_SeoXTemplates_Model_Resource_Template_Relation_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     * Load by template id
     *
     * @param int $templateId
     * @return MageWorx_SeoXTemplates_Model_Resource_Template_Relation_Collection
     */
