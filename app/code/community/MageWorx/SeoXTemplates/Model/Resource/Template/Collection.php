...
abstract class MageWorx_SeoXTemplates_Model_Resource_Template_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    /**
     ...
     * Add cron filter
     *
     * @return MageWorx_SeoXTemplates_Model_Resource_Template_Collection
     */
    ...
    {
        return parent::_toOptionArray('template_id', 'name');
    }
}