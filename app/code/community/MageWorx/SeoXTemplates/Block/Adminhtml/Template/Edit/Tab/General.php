...
class MageWorx_SeoXTemplates_Block_Adminhtml_Template_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $templateCode = $fieldset->addField(
            'code', 'text',
            array(
            'name'     => 'general[code]',
        ...
        $templateCode->setAfterElementHtml(
        ...
        $cronNoticeMessage = '<br>' . $this->__(
            "Note: Do not enable this option if you use the template as a template variable,"
            . " it may lead to duplication."
        );

        $cronNoticeMessage .= '<br>' . $this->__(
            "For example, if your Product Meta Title template is: '[meta_title]-Some_Text',"
