...
$installer->addAttribute(
    'catalog_product', 'product_seo_name',
    array(
    'type'             => 'text',
    'backend'          => '',
    'frontend'         => '',
...
if(!$installer->getConnection()->isTableExists($installer->getTable('mageworx_seoxtemplates/template_product'))){
    $table = $installer->getConnection()
        ...
        ->addColumn(
            'template_id', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(
            'identity'  => true,
            'unsigned'  => true,
            'nullable'  => false,
            'primary'   => true,
        ...
        ->addColumn(
            'type_id', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            ), 'Template Type'
        )
        ...
        ->addColumn(
            'code', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
            'nullable'  => false,
            ), 'Template Code'
        )

        ->addColumn(
            'assign_type', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            ), 'Assign Type'
        )
        ...
        ->addColumn(
            'date_apply_start', Varien_Db_Ddl_Table::TYPE_DATETIME, null, array(
            'nullable'  => true,
            ), 'Last Apply Start Date'
        )

        ->addColumn(
            'date_apply_finish', Varien_Db_Ddl_Table::TYPE_DATETIME, null, array(
            'nullable'  => true,
            ), 'Last Apply Finish Date'
        )

        ->addColumn(
            'write_for', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'  => 1,
            ), 'Write for'
        ...
        ->addColumn(
            'use_cron', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'  => 2,
            ), 'Use Cron'
...
if(!$installer->getConnection()->isTableExists($installer->getTable('mageworx_seoxtemplates/template_relation_attributeset'))){
    $table = $installer->getConnection()
        ...
        ->addColumn(
            'attributeset_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            ), 'Attribute Set ID'
        )
