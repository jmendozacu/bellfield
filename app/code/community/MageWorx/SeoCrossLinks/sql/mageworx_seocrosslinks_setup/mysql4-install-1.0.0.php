...
if (!$installer->getConnection()->isTableExists($installer->getTable('mageworx_seocrosslinks/crosslink'))) {
    $table = $installer->getConnection()
        ...
        ->addColumn(
            'crosslink_id', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(
            'identity'  => true,
            'unsigned'  => true,
            'nullable'  => false,
            'primary'   => true,
        ...
        ->addColumn(
            'keyword', Varien_Db_Ddl_Table::TYPE_TEXT, null, array(
            'nullable'  => false,
            ), 'Keyword'
        )

        ->addColumn(
            'link_title', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
            'nullable'  => false,
            ), 'Title Link'
        )

        ->addColumn(
            'link_target', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
            ), 'Target Link'
        ...
        ->addColumn(
            'replacement_count', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
         ...
         ->addColumn(
             'ref_static_url', Varien_Db_Ddl_Table::TYPE_TEXT, null, array(
             'nullable'  => true,
             ), 'Reference by Custom URL'
         )

        ->addColumn(
            'ref_product_sku', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
            'nullable'  => true,
            ), 'Reference by Product SKU'
        )

        ->addColumn(
            'ref_category_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned'  => true,
            'nullable'  => true,
        ...
        ->addColumn(
            'in_product', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
            ), 'Use in Product Page'
        ...
        ->addColumn(
            'in_category', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
        ...
        ->addColumn(
            'in_cms_page', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
            ), 'Use in CMS Page'
        ...
        ->addColumn(
            'in_blog', Varien_Db_Ddl_Table::TYPE_TINYINT, null, array(
            'unsigned'  => true,
            'nullable'  => false,
            'default'   => 1,
            ), 'Use in Blog'
        ...
        ->addColumn(
            'store_ids', Varien_Db_Ddl_Table::TYPE_VARCHAR, 255, array(
            'nullable'  => false,
            ), 'Store IDs'
        )
...
$installer->addAttribute(
    'catalog_product', 'exclude_from_crosslinking',
    array(
...
$installer->addAttribute(
    'catalog_category', 'exclude_from_crosslinking',
    array(
