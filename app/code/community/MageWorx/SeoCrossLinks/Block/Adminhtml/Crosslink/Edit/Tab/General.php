...
class MageWorx_SeoCrossLinks_Block_Adminhtml_Crosslink_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $kNote1 = $this->__(
            "NOTE: Enter one keyword (keyword phrase) per line. "
            . "A new cross link rule will be created for each entered keyword."
        );

        $kNote2 = $this->__(
            "&nbsp;&nbsp;&nbsp;&nbsp;For multiple keywords use the Reduced Multisave Priority feature."
        ...
        $kNote3 = $this->__(
            "&nbsp;&nbsp;&nbsp;&nbsp;Adding '+' before or after a keyword will apply the Cross Link rule to all its variations. "
