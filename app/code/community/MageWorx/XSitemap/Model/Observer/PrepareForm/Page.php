...
class MageWorx_XSitemap_Model_Observer_PrepareForm_Page extends Mage_Core_Model_Abstract
{
    /**
    ...
    public function addFormFieldsForCmsPage($observer)
    {
        ...
        $fieldset->addField(
            'exclude_from_sitemap', 'select',
            array(
            'name'   => 'exclude_from_sitemap',
            'label'  => Mage::helper('mageworx_xsitemap')->__('Exclude from XML Sitemap'),
            'values' => $values,
            )
        );
