...
abstract class MageWorx_XSitemap_Model_Resource_Catalog_Product_AbstractXml extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
    ...
    {
        $categories = Mage::getResourceModel('mageworx_xsitemap/catalog_category')->getCollection($storeId);
