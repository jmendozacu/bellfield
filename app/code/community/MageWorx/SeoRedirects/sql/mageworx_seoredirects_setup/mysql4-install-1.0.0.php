...
$installer->addAttribute(
    'catalog_category', 'redirect_priority', array(
...
if (!$installer->getConnection()->isTableExists($installer->getTable('mageworx_seoredirects/redirect_product'))) {
    $table = $installer->getConnection()
        ...
        ->addColumn(
            'redirect_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'identity'  => true,
            'unsigned'  => true,
            'nullable'  => false,
            'primary'   => true,
        ...
        ->addColumn(
            'priority_category_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'unsigned'  => true,
            'nullable'  => true,
        ...
        ->addColumn(
            'hits', Varien_Db_Ddl_Table::TYPE_SMALLINT, null, array(
                'unsigned'  => true,
                'nullable'  => false,
                'default'   => 0,
            ), 'Store Id'
