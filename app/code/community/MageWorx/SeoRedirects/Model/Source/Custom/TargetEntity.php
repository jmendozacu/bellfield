 ...
 */
class MageWorx_SeoRedirects_Model_Source_Custom_TargetEntity extends MageWorx_SeoAll_Model_Source
{
    /**
     *
     * @return array
     ...
     * @return array
     */
    public function toTargetOptionArray()
    {
        return array(
            array(
                'value' => 'target_' . MageWorx_SeoRedirects_Model_Redirect_Custom::CUSTOM_URL_ENTITY_TYPE_ID,
                'label' => Mage::helper('mageworx_seoredirects')->__('Custom URL')
            ),
            array(
                'value' => 'target_' . MageWorx_SeoRedirects_Model_Redirect_Custom::PRODUCT_ENTITY_TYPE_ID,
                'label' => Mage::helper('adminhtml')->__('Product'),
            ),
            array(
                'value' => 'target_' . MageWorx_SeoRedirects_Model_Redirect_Custom::CATEGORY_ENTITY_TYPE_ID,
                'label' => Mage::helper('catalog')->__('Category'),
            ),
            array(
                'value' => 'target_' . MageWorx_SeoRedirects_Model_Redirect_Custom::CMS_PAGE_ENTITY_TYPE_ID,
                'label' => Mage::helper('mageworx_seoredirects')->__('CMS Page')
            ),
        );
    }
