...
class AM_RevSlider_Block_Slider_Preview extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface{
    ...
    protected function _toHtml(){
        ...
        if ($slider && $slider->getId() && ($slider->getStatus() == 1 || $quickPreview)){
            ...
            $styles = array();
            $styles[] = Mage::getBaseUrl('js', true).'am/revslider/rs-plugin/css/settings.css?v=4.6.0';
            $styles[] = $this->getUrl('revslider/index/getCssCaptions', array('id' => $slider->getId(), '_forced_secure' => true));
            $styles[] = $this->getSkinUrl('css/arw-revslider-custom_style.css', array('_secure'=>true));
