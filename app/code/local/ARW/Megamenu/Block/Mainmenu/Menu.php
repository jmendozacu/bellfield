...
class ARW_Megamenu_Block_Mainmenu_Menu extends Mage_Catalog_Block_Navigation
{
                                                   ...
                                                   $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        $html[] = '<a onclick="LayNav.categoryClick(this); return false;" class="'.$title_group . $linkClass .'" href="'.$this->getCategoryUrl($category).'">';
                                                   ...
                                                   $isOutermost = false, $outermostItemClass = '', $childrenWrapClass = '', $noEventAttributes = false)
    {
        ...
        $labelCategory = $this->_getCategoryLabelHtml($catdetail, $level);
		$category_icon	=$this->_getCategoryIconHtml($catdetail, $level);
        $html[] = '<a onclick="LayNav.categoryClick(this); return false;" href="'.$this->getCategoryUrl($category).'"'.$linkClass.'>';
